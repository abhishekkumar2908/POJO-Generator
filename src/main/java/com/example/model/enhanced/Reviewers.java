...
/**
 * Constraint-aware POJO for table: reviewers
...
public class Reviewers {
    ...
    public Reviewers(boolean actionPerformed, long modifiedBy, long correctionsId, long createdAt, long id, long modifiedAt, long createdBy) {
